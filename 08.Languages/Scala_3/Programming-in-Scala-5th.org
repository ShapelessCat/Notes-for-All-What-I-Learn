...
* TODO 10 Composition and Inheritance - 206 - =READING=
...
** TODO 10.8 Using ~override~ modifiers - 217
** TODO 10.9 Polymorphism and dynamic binding - 219
** TODO 10.10 Declaring ~final~ members - 221
** TODO 10.11 Using composition and inheritance - 222
** TODO 10.12 Implementing ~above~, ~beside~, and ~toString~ - 224
** TODO 10.13 Defining a factory object - 226
** TODO 10.14 Heighten and widen - 228
** TODO 10.15 Putting it all together - 230
** TODO 10.16 Conclusion - 233
...
** TODO 11.2 Thin versus rich interfaces - 237
...
- To enrich an interface using traits, simply define a trait with a small number
  ...
  large number of concrete methods, all implemented in terms of the abstract
  methods. Then you can mix the enrichment trait into a class, implement the
  thin portion of the interface, and end up with a class that has all of the
...
** TODO 11.3 Traits as stackable modifications - 239 =RE-READ=
- One major use of traits:
...
** TODO 11.4 Why not multiple inheritance? - 243
...
** TODO 11.5 Trait parameters - 248
** TODO 11.6 Conclusion - 250
