...
** DONE 2 Getting started with functional programming in Scala - 15
...
*** DONE 2.1 Introducing Scala the language - 15
...
**** DONE 2.1.1 Running our program - 19
...
*** DONE 2.2 Objects and namespaces - 20
...
*** DONE 2.3 Higher-order functions: passing functions to functions - 21
    CLOSED: [2017-04-05 Wed 16:52]
...
**** 2.3.1 A short detour: writing loops functionally - 21
...
**** 2.3.2 Writing our first higher-order function - 24
...
*** DONE 2.4 Polymorphic functions: abstracting over types - 25
    CLOSED: [2017-03-18 Sat 04:18]
    - /monomorphic/

    - /polymorphic/

**** 2.4.1 An example of a polymorphic function - 25
...
**** 2.4.2 Calling higher-order functions with anonymous functions - 26
...
*** DONE 2.5 Following types to implementations - 27
...
*** DONE 2.6 Conclusion - 30
**** DONE Summary - 31
     CLOSED: [2017-03-18 Sat 04:20]

**** DONE Exercise Answers - 32

** DONE 3 Functional data structures - 34
   CLOSED: [2017-03-18 Sat 22:02]
*** DONE 3.1 Defining functional data structures - 35
...
*** DONE 3.3 Data sharing in functional data structures - 40
...
**** 3.3.1 The efficiency of data sharing - 42
...
**** DONE 3.3.2 Recursion over lists and generalizing to higher-order functions - 43
...
**** 3.4.1 More functions for working with lists - 47
...
**** TODO 3.4.2 Loss of efficiency when assembling list functions from simpler components - 49
...
*** DONE 3.5 Conclusion - 55
**** DONE Summary - 55
     CLOSED: [2017-03-18 Sat 22:02]

*** DONE 3.6 Exercise answers - 56

** DONE 4 Handling errors without exceptions - 67 =ing...=
...
*** DONE 4.1 The good and bad aspects of exceptions - 68
...
*** DONE 4.2 Possible alternatives to exceptions - 70
    CLOSED: [2017-03-19 Sun 23:05]
...
*** DONE 4.3 The ~Option~ data type - 71
...
**** DONE 4.3.1 Usage patterns for ~Option~ - 72
...
**** DONE 4.3.2 ~Option~ composition, lifting, and wrapping exception-oriented APIs - 76
     CLOSED: [2018-06-27 Wed 20:42]
...
*** DONE 4.4 The ~Either~ data type - 81
    CLOSED: [2018-06-28 Thu 01:16]
...
**** Accumulating errors - 83
**** Extracting a Validated type - 85

*** DONE 4.5 Conclusion - 89
**** DONE Summary - ???
     CLOSED: [2018-06-28 Thu 01:16]
     - The bigger idea:
...
*** DONE 4.6 Exercise answers - 90

** DONE 5 Strictness and laziness - 94
...
*** DONE 5.1 Strict and non-strict functions - 95
...
*** DONE 5.2 Lazy lists: An extended example - 98
    CLOSED: [2021-06-05 Sat 18:06]
**** DONE 5.2.1 Memoizing lazy lists and avoiding recomputation - 99
...
**** DONE 5.2.2 Helper functions for inspecting lazy lists - 100
     CLOSED: [2021-06-05 Sat 18:06]
     - EXERCISE 5.1
...
*** TODO 5.3 Separating program description from evaluation - 101 - =RE-NOTE=
...
*** TODO 5.4 Infinite lazy lists and corecursion - 104
...
*** 5.6 Exercise answers - 110

** TODO 6 Purely functional state - 118
...
*** DONE 6.1 Generating random numbers using side effects - 118
...
*** DONE 6.2 Purely functional random number generation - 120
...
*** DONE 6.3 Making stateful APIs pure - 122
...
*** DONE 6.4 A better API for state actions - 124
...
**** DONE 6.4.1 Combining state actions - 125
...
**** TODO 6.4.2 Nesting state actions - 126
     - =TODO=
       NOTE
...
*** TODO 6.5 A general state action data type - 128
...
*** TODO 6.6 Purely functional imperative programming - 129
    - *Aren't imperative and functional programming opposites?*

    - EXERCISE 6.10

*** DONE 6.7 Conclusion - 132
**** DONE Summary - ???
...
*** DONE 6.8 Exercise answers - 133
* TODO PART 2 Functional design and combinator libraries - 141
...
** DONE 7 Purely functional parallelism - 143
...
*** TODO 7.1 Choosing data types and functions - 144
...
**** DONE 7.1.1 A data type for parallel computations - 146
...
**** DONE 7.1.2 Combining parallel computations - 148 - =NOTE= - =RE-READ=
     CLOSED: [2021-07-17 Sat 23:54]
     - EXERCISE 7.1

**** DONE 7.1.3 Explicit forking - 150 - =NOTE= - =RE-READ=
     CLOSED: [2021-07-18 Sun 00:11]

*** DONE 7.2 Picking a representation - 152
    CLOSED: [2021-07-18 Sun 00:18]
**** TODO 7.2.1 Refining the API - 154

*** TODO 7.3 The algebra of an API - 158
**** TODO 7.3.1 The law of mapping - 159
     - EXERCISE 7.7

**** TODO 7.3.2 The law of forking - 160
**** TODO 7.3.3 Breaking the law: a subtle bug - 161
     - EXERCISE 7.8
...
**** TODO 7.3.4 A fully non-blocking Par implementation using actors - 163
...
*** TODO 7.4 Refining combinators to their most general form - 168
...
*** TODO 7.5 Conclusion - 171
**** TODO Summary - ???

*** TODO 7.6 Exercise answers - 172

** TODO 8 Property-based testing - 179
*** TODO 8.1 A brief tour of property-based testing - 180
**** 8.2.1 Choosing data types and functions - 182
**** 8.2.2 Initial snippets of an API - 183
**** 8.2.3 The meaning and API of properties - 184
**** 8.2.4 The meaning and API of generators - 186
**** 8.2.5 Generators that depend on generated values - 187
**** 8.2.6 Refining the Prop data type - 188

*** TODO 8.2 Test case minimization - 190
**** 8.2.1 Using the library and improving its usability - 192
**** 8.2.2 Some simple examples - 192
**** 8.2.3 Writing a test suite for parallel computations - 194

*** TODO 8.3 Testing higher-order functions and future directions - 199
*** TODO 8.4 The laws of generators - 200
*** TODO 8.5 Conclusion - 201
**** TODO Summary - ???

*** TODO 8.6 Exercise answers - 202

** TODO 9 Parser combinators - 214
...
*** TODO 9.1 Designing an algebra, first - 215
...
*** TODO 9.2 A possible algebra - 220
**** 9.2.1 Slicing and nonempty repetition - 222

*** TODO 9.3 Handling context sensitivity - 225
*** TODO 9.4 Writing a JSON parser - 226
**** 9.4.1 The JSON format - 227
**** 9.4.2 A JSON parser - 227

*** TODO 9.5 Error reporting - 228
**** 9.5.1 A possible design - 229
**** 9.5.2 Error nesting - 230
**** 9.5.3 Controlling branching and backtracking - 232

*** TODO 9.6 Implementing the algebra - 233
**** 9.6.1 One possible implementation - 234
**** 9.6.2 Sequencing parsers - 235
**** 9.6.3 Labeling parsers - 236
**** 9.6.4 Failover and backtracking - 237
**** 9.6.5 Context-sensitive parsing - 238

*** TODO 9.7 Conclusion - 240
**** TODO Summary - ???

*** TODO 9.8 Exercise answers - 241

* TODO PART 3 Common structures in functional design - 253
** TODO 10 Monoids - 255
...
*** DONE 10.1 What is a monoid? - 256
...
*** DONE 10.2 Folding lists with monoids - 258
    CLOSED: [2018-09-02 Sun 03:44]
...
*** TODO 10.3 Associativity and parallelism - 259
...
*** TODO 10.4 Example: Parallel parsing - 261
*** TODO 10.5 Typeclasses - 263
*** TODO 10.6 Foldable data structures - 265
*** TODO 10.7 Composing monoids - 267
**** 10.7.1 Assembling more complex monoids - 267
**** 10.7.2 Using composed monoids to fuse traversals - 269

*** TODO 10.8 Conclusion - 269
**** TODO Summary - ???

*** TODO 10.9 Exercise answers - 271

** TODO 11 Monads - 283
   Purely algebraic trait.

*** DONE 11.1 Functors: generalizing the ~map~ function - 284
...
*** TODO 11.2 Monads: generalizing the ~flatMap~ and ~unit~ functions - 287
**** 11.2.1 The Monad trait - 287
     - Exercise 11.1

     - Exercise 11.2
       *HARD*

*** TODO 11.3 Monadic combinators - 290
    - Exercise 11.3
...
*** TODO 11.4 Monad laws - 291
**** 11.4.1 The associative law - 292
**** 11.4.2 Proving the associative law for a specific monad - 293
     - Exercise 11.7
       *HARD*
...
*** TODO 11.5 Just what is a monad? - 296
**** 11.5.1 The identity monad - 297
     - Exercise 11.17

**** 11.5.2 The State monad and partial type application - 298
     - Exercise 11.18
     - Exercise 11.19
     - Exercise 11.20

*** TODO 11.6 Conclusion - 301
**** TODO Summary - ???

*** TODO 11.7 Exercise answers - 302

** TODO 12 Applicative and traversable functors - 313
...
*** DONE 12.1 Generalizing monads - 314
    CLOSED: [2019-04-30 Tue 13:41]
    TODO NOTE

*** DONE 12.2 The Applicative trait - 314
...
*** TODO 12.3 The difference between monads and applicative functors - 317
**** TODO 12.3.1 The Option applicative versus the Option monad - 317
     - *"Effects" in FP*

**** TODO 12.3.2 The Parser applicative versus the Parser monad - 318

*** TODO 12.4 The advantages of applicative functors - 320
**** 12.4.1 Not all applicative functors are monads - 320
     - Exercise 12.4
     - Exercise 12.5
     - Exercise 12.6

*** TODO 12.5 The applicative laws - 325
...
**** DONE 12.5.1 Left and right identity - 326
...
**** DONE 12.5.2 Associativity - 326 - =Re-Read=
...
**** TODO 12.5.3 Naturality of product - 327
     - Naturality law:
...
*** TODO 12.6 Traversable functors - 329
...
*** TODO 12.7 Uses of Traverse - 331
...
**** TODO 12.7.1 From monoids to applicative functors - 332
     - Exercise 12.15

**** TODO 12.7.2 Traversals with State - 333
     - Exercise 12.16
     - Exercise 12.17

**** TODO 12.7.3 Combining traversable structures - 335
**** TODO 12.7.4 Traversal fusion - 336
     - Exercise 12.18

**** TODO 12.7.5 Nested traversals - 336
     - Exercise 12.19

**** TODO 12.7.6 Monad composition - 336
     - Exercise 12.20

*** TODO 12.8 Conclusion - 337
**** TODO Summary - ???

*** TODO 12.9 Exercise answers - 339

* TODO PART 4 Effects and I/O - 353
  In this part, we'll apply what we covered in parts 1-3 of this book to show how
  FP can express these effectful programs.

  - TODO outline

** TODO 13 External effects and I/O - 355
...
*** DONE 13.1 Factoring effects - 356
...
*** DONE 13.2 A simple IO type - 357 - =TODO= TAKE NOTE
...
**** TODO 13.2.1 Handling input effects - 358
...
**** TODO 13.2.2 Benefits and drawbacks of the simple IO type - 362
     NOTE
     NOTE
     NOTE

*** DONE 13.3 Avoiding the _StackOverflowError_ - 363
    CLOSED: [2019-04-30 Tue 13:28]
    - TODO NOTE

**** 13.3.1 Reifying control flow as data constructors - 363
     #+begin_src scala
       sealed trait IO[A] {
         def flatMap[B](f: A => IO[B]): IO[B] =
           FlatMap(this, f)
...
**** 13.3.2 Trampolining: a general solution to stack overflow - 366
...
*** TODO 13.4 A more nuanced I/O type - 368
**** 13.4.1 Free monads - 370
**** 13.4.2 A monad that supports only console I/O - 371
**** 13.4.3 Pure interpreters - 375

*** TODO 13.5 Non-blocking and asynchronous I/O - 377
**** TODO 13.5.1 Composing free algebras - 379

*** TODO 13.6 Capabilities - 383
*** TODO 13.7 A general-purpose I/O type - 385
**** TODO 13.7.1 The main program at the end of the universe - 386

*** TODO 13.8 Why the IO type is insufficient for streaming I/O - 386
*** TODO 13.9 Conclusion - 388
**** TODO Summary - ???

*** TODO 13.10 Exercise answers - 390

** TODO 14 Local effects and mutable state - 394
*** TODO 14.1 Purely functional mutable state - 395
*** TODO 14.2 A data type to enforce scoping of side effects - 396
**** 14.2.1 A little language for scoped mutation - 397
**** 14.2.2 An algebra of mutable references - 398
**** 14.2.3 Running mutable state actions - 400
**** 14.2.4 Mutable arrays - 402
**** 14.2.5 A purely functional in-place quicksort - 404

*** TODO 14.3 Purity is contextual - 405
**** 14.3.1 What counts as a side effect? - 406

*** TODO 14.4 Conclusion - 407
**** TODO Summary - ???

*** TODO 14.5 Exercise answers - 408

** TODO 15 Stream processing and incremental I/O - 410
*** TODO 15.1 Problems with imperative I/O: an example - 411
*** TODO 15.2 Simple stream transformations - 414
**** 15.2.1 Creating pulls - 415
**** 15.2.2 Composing stream transforrmations - 421
**** 15.2.3 Processing files - 423
***** THE PULL MONAD

**** 15.2.2 Composing and appending processes - 413
**** 15.2.3 Processing files - 414

*** TODO 15.3 Extensible pulls and streams - 424
**** 15.3.1 Effectful streaming computations - 430
**** 15.3.2 Handling errors - 431
**** 15.3.3 Ensuring resource safety - 435
**** 15.3.4 Dynamic resource allocation - 441

*** TODO 15.4 Applications - 442
*** TODO 15.5 Conclusion - 443
**** TODO 15.6 Summary - ???

*** TODO 15.6 Exercise Answers - 444
