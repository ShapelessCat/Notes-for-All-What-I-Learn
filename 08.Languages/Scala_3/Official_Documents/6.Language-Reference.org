...
#+VERSION: 3.4.2-RC1-bin-20240219-bbedb45-NIGHTLY -> 3.7.1-RC1-bin-20250328-d519790-NIGHTLY
...
_Starting in Scala 3.7, the elements of a tuple can be named._
...
- *ILLEGAL*:
  * MIXes named and unnamed elements in a tuple
  * Uses the same name for two different elements.

***** Conformance and Convertibility
*The order of names in a named tuple matters.*
...
**** TODO Automatic Parameter Unrolling - =NEW=
**** TODO Reference-able Package Objects - =NEW=
