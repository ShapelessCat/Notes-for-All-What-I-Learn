...
* TODO 2 Inlining - 43
** 2.1 Singleton types - 43
** 2.2 Literal singleton types - 47
** 2.3 Inlined constants - 48
** 2.4 Inline methods - 50
** 2.5 Preserving semantics - 53
** 2.6 Partial evaluation - 54
** 2.7 Inline methods and inheritance - 58
** 2.8 Abstract methods can be inline - 59
** 2.9 Performance considerations - 61
** 2.10 Conclusion - 64

* TODO 3 Metapgrogramming - 65
** 3.1 Inline matches - 65
** 3.2 Transparent inline methods - 69
** 3.3 Constructor patterns in inline matches - 71
** 3.4 Compiler errors from inline matches - 73
** 3.5 Summoning in inline methods - 74
** 3.6 Converting from type to term - 77
** 3.7 Conclusion - 80

* TODO 4 Type-level functions - 81
** 4.1 Value-level functions - 81
** 4.2 Substitution - 83
** 4.3 Currying - 84
** 4.4 Overriding - 86
** 4.5 Polymorphic functions - 87
** 4.6 Viewing types as sets - 91
** 4.7 Kinds - 95
** 4.8 To be continued - 101

* DONE 5 Implementing Lists - 102
...
** DONE 5.1 The ~List~ class in principle - 102
...
** DONE 5.2 The ~ListBuffer~ class - 108
...
** DONE 5.3 The ~List~ class in practice - 109
   CLOSED: [2018-03-20 Tue 03:47]
...
** DONE 5.4 Functional on the outside - 112
...
* DONE 6 For Expressions Revisited - 114
...
** DONE 6.2 The n-queens problem - 95
CLOSED: [2018-03-28 Wed 23:43]
...
** DONE 6.3 Querying with ~for~ expressions - 120
CLOSED: [2017-10-21 Sat 22:00]

** DONE 6.4 Translation of ~for~ expressions - 122 =Re-READ=
...
** DONE 6.5 Going the other way - 126
...
** DONE 6.6 Generalizing ~for~ - 127 =Re-Read the last some paragraph=
...
** DONE 6.7 Conclusion - 129
CLOSED: [2017-10-21 Sat 22:29]

* TODO 7 The Architecture of Scala Collections - 130
...
** 7.1 Factoring out common operations - 108
...
** 7.2 Integrating new collections - 139
...
** DONE 8.1 An example: extracting email addresses - 163
...
** DONE 8.3 Patterns with zero or one variables - 167
...
** DONE 8.4 Optionless extractors - 169
** DONE 8.5 Variable argument extractors - 172
...
** DONE 8.6 Optionlees variable argument extractors - 176
** DONE 8.7 Extractors and sequence patterns - 178
...
** DONE 8.8 Extractors versus case classes - 180
...
** DONE 8.9 Regular expressions - 182
CLOSED: [2020-09-27 Sun 04:29]
...
** DONE 8.10 Conclusion - 185 - =RE-READ=
...
** DONE 9.1 Why have annotations? - 186
...
** DONE 9.2 Syntax of annotations - 187
CLOSED: [2017-10-21 Sat 18:59]
...
** DONE 9.3 Standard annotations - 189 - =TODO=
...
* DONE 10 Modular Programming Using Objects - 194 - =Re-READ=
...
** DONE 10.1 The problem - 195 =Re-Read= =Review=
...
** TODO 10.2 A recipe application - 196
** TODO 10.3 Abstraction - 199
- Use /abstract classes/

** TODO 10.4 Splitting modules into traits - 202
- Split /every large abstract class/ to multiple /traits/.

** TODO 10.5 Runtime linking - 204
** TODO 10.6 Tracking module instances - 205
** TODO 10.7 Conclusion - 207

* DONE 11 Object Equality - 209
...
** DONE 11.1 Equality in Scala - 209
...
** DONE 11.2 Writing an equality method - 210
...
** DONE 11.3 Defining equality for parameterized types - 222
...
** DONE 11.4 Recipes for ~equals~ and ~hashCode~ - 226
CLOSED: [2018-07-19 Thu 18:27]
...
* DONE 12 Combining Scala and Java - 233
...
** DONE 12.1 Using Scala from Java - 233
...
** DONE 12.4 Compiling Scala and Java together - 243
...
** DONE 12.5 Java 8 integration - 244
...
** DONE 11.6 Conclusion - 247
CLOSED: [2018-02-07 Wed 02:10]

* DONE 13 Futures and Concurrency - 248
...
** DONE 13.1 Trouble in paradise - 248 =Re-Do=
...
** DONE 13.2 Asynchronous execution and ~Try~'s - 250
...
** DONE 13.3 Working with ~Future~'s - 253
...
** DONE 13.4 Testing with ~Future~'s - 267
...
* DONE 14 Combinator Parsing - 271
...
** DONE 14.1 Example: Arithmetic expressions - 272
...
** DONE 14.2 Running your parser - 274
...
** DONE 14.3 Basic regular expression parsers - 275
...
** DONE 14.4 Another example: JSON - 276
CLOSED: [2018-03-05 Mon 19:35]
~JSON~ parser

** DONE 14.5 Parser output - 278
...
** DONE 14.6 Implementing combinator parsers - 284
...
** DONE 14.7 String literals and regular expressions - 293
...
** DONE 14.8 Lexing and parsing - 294
...
** DONE 14.10 Backtracking versus LL(1) - 296
...
** DONE 14.11 Conclusion - 298 =Re-Read=
