...
** 1.8 The ~Matchable~ trait - 36
** 1.9 Conclusion - 41

* TODO 2 Inlining - 42
** 2.1 Singleton types - 42
** 2.2 Literal singleton types - 46
** 2.3 Inlined constants - 47
** 2.4 Inline methods - 49
** 2.5 Preserving semantics - 52
** 2.6 Partial evaluation - 53
** 2.7 Inline methods and inheritance - 57
** 2.8 Abstract methods can be inline - 58
** 2.9 Performance considerations - 60
** 2.10 Conclusion - 63

* TODO 3 Metapgrogramming - 64
** 3.1 Inline matches - 64
** 3.2 Transparent inline methods - 68
** 3.3 Constructor patterns in inline matches - 70
** 3.4 Compiler errors from inline matches - 72
** 3.5 Summoning in inline methods - 73
** 3.6 Converting from type to term - 76
** 3.7 Conclusion - 79

* DONE 4 Implementing Lists - 80
...
** DONE 4.1 The ~List~ class in principle - 80
...
** DONE 4.2 The ~ListBuffer~ class - 86
...
** DONE 4.3 The ~List~ class in practice - 87
   CLOSED: [2018-03-20 Tue 03:47]
...
** DONE 4.4 Functional on the outside - 90
...
* DONE 5 For Expressions Revisited - 92
...
** DONE 5.2 The n-queens problem - 95
   CLOSED: [2018-03-28 Wed 23:43]
...
** DONE 5.3 Querying with ~for~ expressions - 98
   CLOSED: [2017-10-21 Sat 22:00]

** DONE 5.4 Translation of ~for~ expressions - 100 =Re-READ=
...
** DONE 5.5 Going the other way - 104
...
** DONE 5.6 Generalizing ~for~ - 105 =Re-Read the last some paragraph=
...
** DONE 5.7 Conclusion - 107
   CLOSED: [2017-10-21 Sat 22:29]

* TODO 6 The Architecture of Scala Collections - 108
...
** 6.1 Factoring out common operations - 108
...
** 6.2 Integrating new collections - 117
...
** DONE 7.1 An example: extracting email addresses - 141
...
** DONE 7.3 Patterns with zero or one variables - 145
...
** DONE 7.4 Optionless extractors - 147
** DONE 7.5 Variable argument extractors - 150
...
** DONE 7.6 Optionlees variable argument extractors - 154
** DONE 7.7 Extractors and sequence patterns - 156
...
** DONE 7.8 Extractors versus case classes - 158
...
** DONE 7.9 Regular expressions - 160
   CLOSED: [2020-09-27 Sun 04:29]
...
** DONE 7.10 Conclusion - 163 - =RE-READ=
...
** DONE 8.1 Why have annotations? - 164
...
** DONE 8.2 Syntax of annotations - 165
   CLOSED: [2017-10-21 Sat 18:59]
...
** DONE 8.3 Standard annotations - 167 - =TODO=
...
* DONE 9 Modular Programming Using Objects - 172 - =Re-READ=
...
** DONE 9.1 The problem - 173 =Re-Read= =Review=
...
** TODO 9.2 A recipe application - 174
** TODO 9.3 Abstraction - 177
   - Use /abstract classes/

** TODO 9.4 Splitting modules into traits - 180
   - Split /every large abstract class/ to multiple /traits/.

** TODO 9.5 Runtime linking - 182
** TODO 9.6 Tracking module instances - 183
** TODO 9.7 Conclusion - 185

* DONE 10 Object Equality - 187
...
** DONE 10.1 Equality in Scala - 187
...
** DONE 10.2 Writing an equality method - 188
...
** DONE 10.3 Defining equality for parameterized types - 200
...
** DONE 10.4 Recipes for ~equals~ and ~hashCode~ - 204
   CLOSED: [2018-07-19 Thu 18:27]
...
* DONE 11 Combining Scala and Java - 211
...
** DONE 11.1 Using Scala from Java - 211
...
** DONE 11.4 Compiling Scala and Java together - 221
...
** DONE 11.5 Java 8 integration - 222
...
** DONE 11.6 Conclusion - 225
   CLOSED: [2018-02-07 Wed 02:10]

* DONE 12 Futures and Concurrency - 226
...
** DONE 12.1 Trouble in paradise - 226 =Re-Do=
...
** DONE 12.2 Asynchronous execution and ~Try~'s - 228
...
** DONE 12.3 Working with ~Future~'s - 231
...
** DONE 12.4 Testing with ~Future~'s - 208
...
* DONE 13 Combinator Parsing - 249
...
** DONE 13.1 Example: Arithmetic expressions - 250
...
** DONE 13.2 Running your parser - 252
...
** DONE 13.3 Basic regular expression parsers - 253
...
** DONE 13.4 Another example: JSON - 254
   CLOSED: [2018-03-05 Mon 19:35]
   ~JSON~ parser

** DONE 13.5 Parser output - 256
...
** DONE 13.6 Implementing combinator parsers - 262
...
** DONE 13.7 String literals and regular expressions - 271
...
** DONE 13.8 Lexing and parsing - 272
...
** DONE 13.10 Backtracking versus LL(1) - 274
...
** DONE 13.11 Conclusion - 276 =Re-Read=
