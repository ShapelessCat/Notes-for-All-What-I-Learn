...
*** DONE 7.2.2 Traversing with ~Applicative~'s - 171 - =RE-READ=
...
**** DONE 7.2.2.3 Exercise: Traversing with ~Validated~ - 177 - =TODO= - =Learn= ~Validated~
     CLOSED: [2021-08-12 Thu 14:26]
     #+begin_src scala
...
*** DONE 7.2.3 ~Traverse~ in Cats - 174
    ...
    - Cats provides instances of ~Traverse~ for ~List~, ~Vector~, ~Stream~, ~Option~,
      ...
      #+begin_src scala
        ...
        import cats.instance.future.given  // or Applicative
        import cats.instance.list.given    // or Traverse
