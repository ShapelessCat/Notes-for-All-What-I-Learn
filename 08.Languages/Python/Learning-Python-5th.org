...
***** DONE Enclosing scopes and ~global~'s - 1286
CLOSED: [2024-10-30 Wed 17:02]
...
***** DONE Enclosing scopes and ~nonlocal~'s - 1287
...
**** TODO Class Blunders I: Decorating Methods - 1289 - =NOTE=
...
*** DONE Managing Functions and Classes Directly - 1312
CLOSED: [2024-10-30 Wed 21:04]
Another way to use /decorators/: return decorated function or class instance
creation calls directly, but add some extra info, like register them or add
attributes to them.

- Example 1: Registry for functions or classes
  #+begin_src python
    registry = {}
...
- Example 2: Add attributes to functions or classes
  #+begin_src python
    def decorate(func):
        func.marked = True
        return func
...
** TODO 40. Metaclasses - 1355 - =READING!!=
- In a sense,
...
- Really, there's a hole in the /Python's type model/ we've seen thus far:
  * Q :: if /instances/ are created from /classes/, what is it that creates
    our /classes/?

  * A :: _It turns out that /classes/ are /instances/ of something, too_:
