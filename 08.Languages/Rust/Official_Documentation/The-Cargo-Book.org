...
This section provides a quick sense for the cargo command line tool.

We demonstrate
- its ability to _generate_ a new /package/ for us,
- its ability to _compile_ the /crate/ within the /package/, and
- its ability to _run_ the resulting program.
...
** 3.2. Workspaces
** 3.3. Specifying Dependencies - _READING_
...
**** Specifying path dependencies - =TODO: NOTE= =IMPORTANT for workspace=
***** No local path traversal
***** Local paths in published crates

**** Multiple locations - =TODO: NOTE= =IMPORTANT for workspace=
**** Platform specific dependencies - =TODO: NOTE=
***** Custom target specifications

**** Development dependencies - =TODO: NOTE=
**** Build dependencies - =TODO: NOTE=
**** Choosing features - =TODO: NOTE=
**** Renaming dependencies in =Cargo.toml= - =TODO: NOTE=
**** Inheriting a dependency from a workspace - =TODO: NOTE=

*** 3.3.1. Overriding Dependencies
*** 3.3.2. Source Replacement
...
** 3.11. External Tools
** 3.12. Registries
*** 3.12.1. Registry Authentication
**** 3.12.1.1. Credential Provider Protocol

*** 3.12.2. Running a Registry
**** 3.12.2.1. Registry Index
**** 3.12.2.2. Registry Web API
...
** 4.6. Deprecated and Removed

* TODO 5. FAQ - =TODO: NOTE=
- Q :: Is the plan to use GitHub as a package repository?
- Q :: Why build crates.io rather than use GitHub as a registry?
- Q :: Will Cargo work with C code (or other languages)?
- Q :: Can Cargo be used inside of make (or ninja, or ...)
- Q :: Does Cargo handle multi-platform packages or cross-compilation?
- Q :: Does Cargo support environments, like ~production~ or ~test~?
- Q :: Does Cargo work on Windows?
- Q :: Why have =Cargo.lock= in version control?
- Q :: Can libraries use * as a version for their dependencies?
- Q :: Why =Cargo.toml=?
- Q :: How can Cargo work offline?
- Q :: Why is Cargo rebuilding my code?
- Q :: What does "version conflict" mean and how to resolve it?
