...
* Preface - xi
In this book, we explore the Rust programming language's INNER
WORKINGS by *examining the _assembly code_ its compiler produces.*

We will investigate
- the performance implications,
- memory representations, and
- optimizations performed by the Rust compiler and the LLVM backend.

** Who Should Read This Book? - xi
This book serves as a practical reference for those interested in Rust
programming. You can jump directly to chapters that are relevant to your needs.
When reading a chapter, you can select the level of detail that suits your
current understanding.

** Structure of This Book - xii
**** Part A: Introduction to Assembly and Basic Constructs
**** Part B: Control Structures and Enums in Assembly
**** Part C: Data Structures and Memory Management
**** Part D: Iteration and Optimization
**** Part E: Strings, Dispatch, and Recursion
**** Part F: Closures and Async/Await
**** Part G: Transformations and Takeaways
