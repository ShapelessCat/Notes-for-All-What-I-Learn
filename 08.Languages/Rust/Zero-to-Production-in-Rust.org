...
- Zero To Production will focus on the challenges of writing Cloud-native
  applications in a team offour or five engineers with different levels of
  experience and proficiency.

*** Cloud-native applications - xv
- Cloud-native applications (Paraphrasing Cornelia Davis) ::
  ...
  * To handle dynamic workloads (e.g. request volumes).
  ...
  These requirements have a deep impact on the viable solution space for the
...
- We will cover how to instrument your Rust application to collect logs, traces and metrics to be able to
  ...
  We will cover all the material required to use Rust to tackle both day one and day two concerns of a Cloudnative
  API.
