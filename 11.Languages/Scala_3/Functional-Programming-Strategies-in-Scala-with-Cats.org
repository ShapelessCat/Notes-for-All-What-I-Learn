...
#+AUTHOR: Noel Welsh
#+Date: June 2024 -> Draft built on 2026-03-25
#+STARTUP: entitiespretty
#+STARTUP: indent
#+STARTUP: overview

* DONE Preface - xvii
CLOSED: [2025-12-18 Thu 12:29]
- The author's path:
  1. He started his career twenty years ago in UK, during his commute time he
     found SICP and read it. He thinks:
     * it's core concepts were timeless and
     * it's fair to say it absolutely blew my mind,
       *putting me on a path I'm still on today.*

  2. Another notable stop on this path occured some ten years ago when Dave
     and I started writing _Scala with Cats_.

  3. He lately found:
     1) /type classes/ are *only a small piece* of the puzzle of building software
        in a functional programming style.
     2) We needed a *much wider scope*
        IF we were to show people how to effectively build software with all the
        tools that functional programming provides.

  4. No time to work on _Scala with Cats_ until around 2020.
     The author _first want to update_ the code in this book to Scala 3.
     Dave, the other author, was busy with other projects so the author decided
     to go alone.

  5. As the writing got underway the author realized he really wanted to cover
...
** DONE Preface from Scala with Cats - xviii
CLOSED: [2025-12-18 Thu 12:20]
- The *AIMS* (=from Jian= *GOALS*) of this book are _TWO-FOLD_:
...
- We have extended
  ...
  * many smaller examples, and of course
  * the mathematical definitions.

  Between them we hope you'll find something that works for you.

** DONE Versions - xix
CLOSED: [2025-12-18 Thu 12:24]
This book use *Scala 3.7.3* and *Cats 2.13.0*.
You can use this minimal =build.sbt= containing the relevent dependencies and
settings:
#+BEGIN_SRC scala
  scalaVersion := "3.7.4"
...
*** DONE Template Projects - xix
CLOSED: [2025-12-18 Thu 12:23]
- The minimal one:
  ~sbt new scalawithcats/cats-seed.g8~
  * This will generate a sandbox project with Cats as a dependency.

- =from Jian=
  Only show up in old versions, and not in this version, but might be useful:
...
** DONE Conventions Used in This Book - xx
CLOSED: [2025-12-18 Thu 12:28]
...
=IMPORTANT=
- BLUE ones: tips
- BROWN ones: advanced callouts provide additional info
...
This is a book on
*strategies* for creating code in a /functional programming (FP) style/,
_seen through a Scala lens_.

- *THIS BOOK IS FOR YOU*
  * IF
    you understand most of _the mechanics of Scala_,
    BUT
    feel there is something missing in your understanding of how to use the
    language effectively,

  * IF
    you don't know so much Scala,
    BUT
    are prepared to learn it as part of learning about /functional programming/,

- This book
  1. COVERS the usual /functional programming abstractions/ like
     /monads/ and /monoids/,

  2. BUT *MORE THAN THAT*  =IMPORTANT=
  ...
  3. It is a book
       AS much
         ABOUT *process*
       AS
        it is ABOUT the _code that results from *process*,_
     AND
        in particular
        it _FOCUSES ON_ what I call /metacognitive programming strategies/.

     - Metacognition :: thinking about thinking.
       * Functional programmers love fancy words for SIMPLE ideas -
         =from Jian= just like this one, SIMPLE and really CRITICAL.

       * A lot of research has shown the benefits of /metacognition/ in learning
         and its importance in developing expertise (see, for example,
         [14,51,66]). =READ=

       * =TODO=
         /Metacognition/ is *NOT* just one thing -- it's not sufficient to just
         tell someone to think about their thinking.

         _RATHER_,
         /metacognition/ is *a collection of different strategies,*
         some of which are general and some of which are domain specific.

         =IMPORTANT=
         From this we get the idea of /metacognitive programming strategies/ --
         *explicitly naming and describing different thinking strategies that
         proficient programmers use.*

- Let's think a little about metacognitive strategies you might already use when
  coding. My experience is that most developers struggle to answer this.
  Software teams usually have many well-defined processes around coding, such as
  daily stand-ups and kanban boards. Developers have a huge amount of language
  specific knowledge. However, the part inbetween deciding what should be done
  and working code is often very fuzzy. When developers can answer this question
  they often mention test driven development and pair programming, and design
  patterns such as the builder pattern. These date from the nineties, the former
  from Extreme Programming [4] and the latter from the Design Patterns book
  [30]. In my experience they are used quite informally, if at all.
  =TODO= =RE-ORG=

- The _QUESTION_ then becomes:
  * Q :: What /metacognitive strategies/ can programmers use?

  * A :: I believe that /functional programming/ is particularly well suited to
    answer this question.

    A major theme in /functional programming/ research is finding and naming
    useful code structures.

    Once we have discovered a useful abstraction we can get the programmer to
    ask themselves “would this abstraction solve this problem?” This is
    essentially what the design patterns community did, also back in the
    nineties, but there is an important difference. The academic FP community
    strongly values formal models, which means that the building blocks of FP
    have a precision that design patterns lack. However there is more to process
    than categorizing the output. There is also the actual process of how the
    code comes to be. Code doesn’t usually spring fully formed from our
    keyboard, and in the iterative refinement of code we also find structure.
    Here the academic FP community has less to say, but there is a strong
    folklore of techniques such as “type driven development”.

- I believe /metacognitive programming strategies/ are useful for both
  _beginners_ and _experts_:

  * For _beginners_
    we can make programming a more SYSTEMATIC and REPEATABLE process.
    Producing code no longer requires magic in the majority of cases, but rather
    the application of well defined steps.

  * For _experts_,
    the benefit is exactly the same. At least that is my experience (and I
    believe I've been programming long enough to call myself an expert.)

- By having an *EXPLICIT process* I can run it exactly the same way every day,
  which
  makes my code simpler to write and read, and
  saves my brain cycles for more important problems.

  In some ways this is an attempt to bring to programming the benefit that
  process and standardization has brought to manufacturing, particularly the
  "Toyota Way".

  * In /Toyota's process/ individuals are expected to think about how their work
    is done and how it can be improved. This is, in effect, /metacognition/ for
    assembly lines.

    =IMPORTANT=
    *This is only possible if the actual work itself does not require their full
    attention.* The dramatic improvements in productivity and quality in car
    manufacturing that Toyota pioneered speak to the effectiveness of this
    approach.

  * Software development is more varied than car manufacturing but we should
    still expect some benefit, particularly given the primitive state of our
    current industry.

- Over the last ten or so years of programming and teaching programming I've
  collected a wide range of strategies.

  * Some come from others (for example, _How to Design Programs_ and its many
    offshoots remain very influential for me) and

  * Some I've found myself.

  Ultimately *I do NOT think anything here is new;* rather my contribution is in
  collecting and presenting these strategies as one coherent whole.

** TODO 1.1. Three Levels for Thinking About Code - 3
- Let's START _thinking about thinking about programming_,
  with a model that describes *THREE different levels* that we can use to think
  about code.
  * The levels, from highest to lowest, are /paradigm/, /theory/, and /craft/.
...
** TODO 2. Types as Constraints - 17
*** TODO 2.1. Sets and Constraints - 17
*** TODO 2.2. Building Constraints - 19
*** TODO 2.3. Opaque Types - 22
**** TODO 2.3.1. Best Practices - 26
**** TODO 2.3.2. Beyond Opaque Types - 28

*** TODO 2.4. Conclusions - 28

** TODO 3. Algebraic Data Types - 31
...
*** DONE 3.1. Building Algebraic Data Types - 31
...
*** DONE 3.2. Algebraic Data Types in Scala - 33
...
*** TODO 3.3. Structural Recursion - 40
- =IMPORTANT=
  =IMPORTANT=
  =IMPORTANT=
...
**** DONE 3.3.1. Pattern Matching - 40
CLOSED: [2025-05-12 Mon 15:08]

**** TODO 3.3.2. The Recursion in Structural Recursion - 41
...
**** DONE 3.3.3. Exhaustivity Checking - 46
CLOSED: [2025-05-12 Mon 15:09]

**** DONE 3.3.4. Dynamic Dispatch - 47
...
***** Exercise: Methods for Tree - 49

**** TODO 3.3.5. Folds as Structural Recursions - 50
***** Exercise: Tree Fold - 53
***** Exercise: Using Fold - 53

*** TODO 3.4. Structural Corecursion - 53
...
*** TODO 3.5. The Algebra of Algebraic Data Types - 64
**** Exercise: Identities - 65

*** TODO 3.6. Conclusions - 67

** TODO 4. Objects as Codata - 71
*** 4.1. Data and Codata - 72
*** 4.2. Codata in Scala - 75
*** 4.3. Structural Recursion and Corecursion for Codata - 78
***** Exercise: Stream Combinators - 86

**** 4.3.1. Efficiency and Effects - 87

*** 4.4. Relating Data and Codata - 91
**** Exercise: Or and Not - 94

*** 4.5. Data and Codata Extensibility - 98
**** Exercise: Sets - 101

*** 4.6. Conclusions - 103

** TODO 5. Contextual Abstraction - 105
...
*** TODO 5.1. The Mechanics of Contextual Abstraction - 106
**** TODO 5.1.1 Using Clauses - 106
**** TODO 5.1.2 Given Instances - 107
**** TODO 5.1.3 Given Scope and Imports - 108
***** TODO 5.1.3.1 Given Instance Priority - 112

*** TODO 5.2. Anatomy of a Type Class - 114
...
**** DONE 5.2.2. Type Class Instances - 115
CLOSED: [2020-02-16 Sun 19:41]
...
**** TODO 5.2.3. Type Class Use - 116
***** 5.2.3.1. Interface Objects - 117
***** 5.2.3.2. Interface Syntax - 117
- *Extension Methods on Traits*

***** 5.2.3.3. The ~summon~ Method - 119

*** TODO 5.3. Type Class Composition - 120
**** 5.3.1. Type Class Composition in Scala 2 - 122

*** TODO 5.4. What Type Classes Are - 123
*** TODO 5.5. Exercise: Display Library - 125
**** 5.5.1. Using the Library - 126
**** 5.5.2. Better Syntax - 126

*** TODO 5.6. Type Classes and Variance - 127
**** 5.6.1. Variance - 127
**** 5.6.2. Covariance - 128
**** 5.6.3. Contravariance - 129
**** 5.6.4. Invariance - 130
**** 5.6.5. Variance and Instance Selection - 130

*** TODO 5.7. Conclusions - 134

** TODO 6. Reified Interpreters - 125
*** 6.1. Regular Expressions - 137
- *Regular Expression Semantics*

*** 6.2. Interpreters and Reification - 148
**** 6.2.1. The Structure of Interpreters - 148
**** 6.2.2. Implementing Interpreters with Reification - 149
***** Exercise: Arithmetic - 150

*** 6.3. Tail Recursive Interpreters - 151
- *The Call Stack*

**** 6.3.1. The Problem of Stack Safety - 152
**** 6.3.2. Tail Calls and Tail Position - 153
- *Runtimes and Tail Calls*

**** 6.3.3. Continuation-Passing Style - 156
***** Exercise: CPS Arithmetic - 160

**** 6.3.4. Trampolining - 160
***** Exericse: Trampolined Arithmetic - 164

**** 6.3.5. When Tail Recursion is Easy - 165

*** 6.4. Conclusions - 168

* DONE Part II. Type Classes - 171
** DONE 7. Using Cats - 173
*** TODO 7.1. Quick Start - 173
*** TODO 7.2. Using Cats - 174
**** TODO 7.2.1 Defining Custom Instances - 175
***** TODO Exercise: Cat Show - 176

*** TODO 7.3. Example: ~Eq~ - 177
**** 7.3.1. Equality, Liberty, and Fraternity - 178
**** 7.3.2. Comparing Ints - 178
**** 7.3.3. Comparing Options - 179
**** 7.3.4. Comparing Custom Types - 180
***** Exercise: Equality, Liberty, and Felinity - 181

*** TODO 7.4. Conclusions - 181

** DONE 8. Monoids and Semigroups - 183
...
**** DONE 8.0.0.1 Integer addition - 165
CLOSED: [2018-10-26 Fri 21:35]
- Operation: Closed under integer ~+~
- Identity: ~0~
- Associativity

**** DONE 8.0.0.2 Integer multiplication - 166
CLOSED: [2018-10-26 Fri 21:35]
- Operation: Closed under integer ~*~
- Identity: ~1~
- Associativity

**** DONE 8.0.0.3 String and sequence concatenation - 166
CLOSED: [2018-10-26 Fri 21:35]
- Operation: Closed under String concatenation ~++~
- Identity: ~""~
- Associativity

*** DONE 8.1. Definition of a ~Monoid~ - 185
...
*** DONE 8.2. Definition of a ~Semigroup~ - 186
...
**** DONE 8.2.0.1. Exercise: The Truth About Monoids - 187
...
**** DONE 8.2.0.2. Exercise: All ~Set~ for Monoids - 187
...
**** DONE 8.3.1. The Monoid Type Class - 188
...
**** DONE 8.3.2. Monoid Instances - 189
...
***** DONE 8.3.3.1 Exercise: Adding All The Things - 191
...
*** DONE 8.4. Applications of Monoids - 191
...
**** DONE 8.4.2. Distributed Systems - 193
CLOSED: [2020-02-18 Tue 02:11]
=TODO= =Case-Study= We explore this idea further in *the CRDT case study*.

**** DONE 8.4.3. Monoids in the Small - 193
CLOSED: [2020-02-18 Tue 02:11]
...
*** DONE 8.5. Summary - 193
CLOSED: [2020-02-18 Tue 02:21]

** DONE 9. Functors - 197 - =TODO= _contravariant and invariant functors_
...
*** DONE 9.1. Examples of Functors - 197
...
*** DONE 9.2. More Examples of Functors - 198
...
*** DONE 9.3. Definition of a Functor - 204
...
*** DONE 9.4. Higher Kinds and Type Constructors - 205
...
**** DONE 9.5.1. The ~Functor~ Type Class and Instances - 207
...
**** DONE 9.5.3. Instances for Custom Types - 211
...
***** DONE Exercise: Branching out with Functors - ??
...
*** DONE 9.6. Contravariant and Invariant Functors - 212 - =TODO=
...
**** DONE 9.6.1. Contravariant Functors and the ~contramap~ Method - 213
...
***** DONE 9.6.1.1 Exercise: Showing off with Contramap - 214
CLOSED: [2019-03-31 Sun 01:55]
#+BEGIN_SRC scala
  trait Printable[A] { self =>
    def format(value: A): String
...
**** DONE 9.6.2. Invariant functors and the ~imap~ method - 216
...
***** DONE 9.6.2.1 Transformative Thinking with ~imap~ - 218
...
*** DONE 9.7. Contravariant and Invariant in Cats - 220 - =TODO=
...
**** TODO 9.7.1. Contravariant in Cats - 220
#+begin_src scala
  // TODO: Example code
#+end_src

**** TODO 9.7.2. Invariant in Cats - 221
#+begin_src scala
  // TODO: Example code
#+end_src

*** TODO 9.8. Aside: Partial Unification - 222
...
- Example:
  ...
  * Without =-Ypartial-unification=, you can see
    #+begin_src scala
      ...
      //                          ^
    #+end_src
**** TODO 9.8.1. Limitations of Partial Unification - 224

*** DONE 9.9. Conclusions - 226
...
**** DONE 10.1.2. ~List~'s as Monads - 232
...
**** DONE 10.1.3. ~Future~'s as Monads - 233
...
**** DONE 10.1.4. Definition of a Monad - 234
...
**** DONE 10.1.5. Exercise: Getting Func-y - 236
CLOSED: [2018-10-28 Sun 00:04]
#+BEGIN_SRC scala
  import scala.language.higherKinds
...
**** DONE 10.2.1. The ~Monad~ Type Class - 236
...
**** DONE 10.2.2. Default Instances - 237
CLOSED: [2019-04-01 Mon 13:32]
...
*** DONE 10.3. The ~Identity~ Monad - 240
CLOSED: [2019-04-01 Mon 14:33]
- TODO NOTE
- TODO NOTE
- TODO NOTE

**** 10.3.1. Exercise: Monadic Secret Identies - 243
#+begin_src scala
...
*** DONE 10.4. ~Either~ - 244
**** TODO 10.4.1. Cats Utilities - 246
***** TODO 10.4.1.1. Creating Instances - 246
***** TODO 10.4.1.2.Transforming Eithers - 249
***** TODO Exercise: What is Best? - 250

*** DONE -- 10.4. ~Either~ - 220
...
*** DONE 10.5. Aside: Error Handling and ~MonadError~ - 250
...
**** DONE 10.5.1. The ~MonadError~ Type Class - 251
...
**** DONE 10.5.2. Raising and Handling Errors - 252
...
**** DONE 10.5.3. Instances of ~MonadError~ - 254
CLOSED: [2019-04-10 Wed 14:02]
...
**** TODO 10.5.4. Exercise: Abstracting - 254 - =OPEN ISSUE=
No exercise here -- there is an open issue for this in github

*** DONE 10.6. The ~Eval~ Monad - 255
...
**** DONE 10.6.1. Eager, Lazy, Memoized, Oh My! - 255
...
**** DONE 10.6.2. Eval's Models of Evaluation - 257
...
**** DONE 10.6.3. ~Eval~ as a ~Monad~ - 259
...
**** DONE 10.6.4. Trampolining and ~Eval.defer~ - 261
...
***** TODO Exercise: Safer Folding using ~Eval~ - 262
=from Jian= I made a mistake at my first try. Try to do it again later.

*** DONE 10.7. The ~Writer~ Monad - 263
...
**** DONE 10.7.1. Creating and Unpacking Writers - 263
...
**** DONE 10.7.2. Composing and Transforming Writers - 265
...
***** DONE Exercise: Show Your Working - 268
CLOSED: [2019-04-14 Sun 02:04]
...
*** DONE 10.8. The ~Reader~ Monad - 269
...
**** DONE 10.8.1. Creating and Unpacking Readers - 270
...
**** DONE 10.8.2. Composing Readers - 270
CLOSED: [2019-04-16 Tue 17:12]
...
***** DONE Exercise: Hacking on Readers - 271
...
**** DONE 10.8.3. When to Use Readers? - 273
...
**** DONE 10.9.1 Creating and Unpacking State - 274
...
**** DONE 10.9.2 Composing and Transforming State - 276
...
***** DONE Exercise: Post-Order Calculator - 278 - =TODO= =RE-READ=
CLOSED: [2020-02-20 Thu 14:20]

*** DONE 10.10. Defining Custom Monads - 281 - HARD - =RE-READ=
CLOSED: [2023-01-11 Wed 09:44]
**** TODO Exercise: Branching out Further with Monads - 283
#+begin_src scala
  sealed trait Tree[+A]
...
** DONE 11. Monad Transformers - 287
...
*** DONE 11.1. Composing Monads - 287
...
*** DONE 11.2. A Transformative Example - 289
...
*** DONE 11.3. Monad Transformers in Cats - 290
...
**** DONE 11.3.1. The Monad Transformer Classes - 290
...
**** DONE 11.3.2. Building Monad Stacks - 291
...
**** DONE 11.3.3. Constructing and Unpacking Instances - 294
...
**** DONE 11.3.4. Default Instances - 295
...
**** DONE 11.3.5. Usage Patterns - 296
CLOSED: [2020-02-16 Sun 01:21]
...
***** DONE Exercise: Monads: Transform and Roll Out - 298
CLOSED: [2020-02-16 Sun 01:55]

*** DONE 11.4. Conclusions - 300
...
** DONE 12. ~Semigroupal~ and ~Applicative~ - 301
...
**** DONE 12.1.1. Joining Two Contexts - 303
...
**** DONE 12.1.2. Joining Three or More Contexts - 304
CLOSED: [2020-02-20 Thu 14:42]
...
**** DONE 12.1.3. Semigroupal Laws - 304

*** DONE 12.2. ~Apply~ Syntax - 305
...
**** DONE 12.2.1. Fancy Functors and Apply Syntax - 306 - =TODO= =???=
...
*** DONE 12.3. ~Semigroupal~ Applied to Different Types - 307
...
**** DONE 12.3.1. ~Semigroupal~ Applied to ~List~ - 307
...
**** DONE 12.3.2. ~Semigroupal~ Applied to ~Either~ - 308
CLOSED: [2020-02-20 Thu 15:43]
#+begin_src scala
...
**** DONE 12.3.3. ~Semigroupal~ Applied to ~Monad~'s - 308
...
***** DONE Exercise: The Product of ~List~'s - 309
...
*** TODO 12.4. ~Parallel~ - 310
**** Exercise: Parallel List - 313

*** DONE 12.5. ~Apply~ and ~Applicative~ - 313
...
**** DONE 12.5.1. The Hierarchy of Sequencing Type Classes - 314
CLOSED: [2020-02-21 Fri 10:36]
...
*** DONE 12.6. Summary - 316
CLOSED: [2020-02-21 Fri 10:42]

** DONE 13. ~Foldable~ and ~Traverse~ - 319
...
**** DONE 13.1.1. Folds and Folding - 319
...
***** DONE Exercise: Reflecting on Folds - 321
CLOSED: [2020-02-21 Fri 10:52]
...
***** DONE Exercise: Scaf-fold-ing Other Methods - 322
...
**** DONE 13.1.2. Foldable in Cats - 322
CLOSED: [2020-02-21 Fri 15:08]
...
***** DONE 13.1.2.1 Folding Right - 323 - =TODO= =RE-READ=
...
***** DONE 13.1.2.2 Folding with Monoids - 324
...
***** DONE 13.1.2.3 Syntax for Foldable - 325
CLOSED: [2020-02-21 Fri 15:08]
...
*** DONE 13.2. ~Traverse~ - 326 - =TODO= 13.2.2 =RE-READ=
CLOSED: [2020-02-22 Sat 00:56]
...
**** DONE 13.2.1. Traversing with ~Future~'s - 327
...
**** DONE 13.2.2. Traversing with ~Applicative~'s - 329 - =TODO=
...
***** DONE Exercise: Traversing with ~Vector~'s - 331
...
***** DONE Exercise: Traversing with ~Option~'s - 331
...
***** DONE Exercise: Traversing with ~Validated~ - 332 - TODO -WHY
CLOSED: [2020-02-21 Fri 15:51]
#+begin_src scala
...
**** DONE 13.2.3. ~Traverse~ in Cats - 332
CLOSED: [2020-02-22 Sat 00:56]
...
*** DONE 13.3. Conclusions - 334
CLOSED: [2020-02-22 Sat 00:56]

* TODO Part III. Interpreters - 335
** TODO 14. Indexed Types - 337
*** 14.1. Phantom Types - 328
*** 14.2. Indexed Codata - 340
***** 14.2.0.1. Exercise: Torque {-} - 342

**** 14.2.1. API Protocols - 343
***** 14.2.1.1. Exercise: HTML API Design {-} - 347

**** 14.2.2. Beyond Equality Constraints - 348
***** 14.2.2.1. Exercise: Commutivitiy {-} - 350

*** 14.3. Indexed Data - 351
**** 14.3.1. The Probability Monad - 352

*** 14.4. Conclusions - 359

** TODO 15. Tagless Final Interpreters - 365
*** TODO 15.1. Codata Interpreters - 365
**** 15.1.1. The Terminal - 366
**** 15.1.2. Color Codes - 367
**** 15.1.3. The Trouble with Escape Codes - 368
**** 15.1.4. Programs and Interpreters - 370
**** 15.1.5. Composition and Reasoning - 376
**** 15.1.6. Codata and Extensibility - 377

*** TODO 15.2. Tagless Final Interpreters - 378
*** TODO 15.3. Algebraic User Interfaces - 385
*** TODO 15.4. A Better Encoding - 391
*** TODO 15.5. Conclusions - 398

** TODO 16. Dependency Injection - 401
*** 16.1. What Are Dependencies - 401
*** 16.2. What Problem Dependency Injection Solves - 402
*** 16.3. Approaches to Dependency Injection - 402
*** 16.4. Constructors Injection and the Reader Monad - 403
**** 16.4.1. Constructor Injection - 403
**** 16.4.2. The Reader Monad - 405
**** 16.4.3. Relating Constructor Injection and the Reader Monad - 407

*** 16.5. Providing Dependencies - 415
**** 16.5.1. The Two Problems of Dependency Provision - 416
**** 16.5.2. Contextual Abstraction - 417

*** 16.6. Bundling Dependencies - 419
**** 16.6.1. Algebraic Data - 402
**** 16.6.2. The Cake Pattern - 402
***** 16.6.2.1. Cake Pattern Best Practices - 423

**** 16.6.3. Tagless Final - 424

*** 16.7. Interpreters as Staged Dependency Injection - 425
**** 16.7.1. Interpreters as Staged Computation - 425
**** 16.7.2. Dependencies in the Interpreter - 425
**** 16.7.3. Trade-offs - 426

*** 16.8. Effect Systems and Dependency Injection - 426
**** 16.8.1. From Tagless Final to Effect Systems - 426
**** 16.8.2. Capabilities as Dependencies - 427
**** 16.8.3. Effect Handlers as Interpreters - 427

*** 16.9. Conclusions - 427

** TODO 17. Optimizing Interpreters and Compilers - 429
*** 17.1. Algebraic Manipulation - 429
*** 17.2. From Continuations to Stacks - 440
*** 17.3. Compilers and Virtual Machines - 444
**** 17.3.1. Virtual and Abstract Machines - 445
**** 17.3.2. Compilation - 446

*** 17.4. From Interpreter to Stack Machine - 447
**** 17.4.1. Effectful Interpreters - 452
**** 17.4.2. Further Optimization - 453

*** 17.5. Conclusions - 457

* TODO Part IV. Case Studies - 461
** DONE 18. Creating Usable Code - 463
...
** DONE 19. Case Study: Reactive Programming - 465
*** 19.1. Reactive Programming - 465
*** 19.2. Designing with Strategies - 466
*** 19.3. Implementing Stream - 470
*** 19.4. Handling State - 472
**** Exercise: Sequence Constructor - 473
**** Exercise: Stream ~take~ - 477
**** Exercise: Stream ~merge~ - 477

*** 19.5. Stream Semantics - 478
**** Exercise: Stream Emit - 480

*** 19.6. Further Enhancements - 480
*** 19.7. Conclusions - 481

** DONE 20. Case Study: Testing Asynchronous Code - 483
...
*** TODO 20.1. Abstracting over Type Constructors - 485
*** TODO 20.2. Abstracting over Monads - 486
*** TODO 20.3. Summary - 487

** DONE 21. Error Handling - 429
*** 21.1. Errors Are Not One Thing - 489
*** 21.2. Requirements for Error Handling - 490
*** 21.3. Tools - 490

** DONE 22. Case Study: Map-Reduce - 491
CLOSED: [2020-02-24 Mon 09:56]
*** TODO 22.1. Parallelizing ~map~ and ~fold~ - 492
*** TODO 22.2. Implementing ~foldMap~ - 494
*** TODO 22.3. Parallelising ~foldMap~ - 496
**** TODO 22.3.1. ~Future~'s, Thread Pools, and ~ExecutionContext~'s - 498
**** TODO 22.3.2. Dividing Work - 500
**** TODO 22.3.3. Implementing ~parallelFoldMap~ - 500
**** TODO 22.3.4. ~parallelFoldMap~ with more Cats - 501

*** TODO 22.4 Summary - 501

** TODO 23. Case Study: Data Validation - 503
- Goals:
  Be able to
...
*** TODO 23.1. Sketching the Library Structure - 504
***** TODO Providing error messages - 504
...
***** TODO Combine checks - 505
***** TODO Accumulating errors as we check - 506
***** TODO Transforming data as we check it - 506

*** TODO 23.2. The Check Datatype - 506
*** TODO 23.3. Basic Combinators - 508
*** TODO 23.4. Transforming Data - 509
**** TODO 23.4.1. Predicates - 511
**** TODO 23.4.2. Checks - 512
**** TODO 23.4.3. Recap - 514

*** TODO 23.5. Kleislis - 515
*** TODO 23.6. Summary - 519

** TODO 24. Case Study: CRDTs - 523
*** TODO 24.1. Eventual Consistency - 523
*** TODO 24.2. The GCounter - 524
**** TODO 24.2.1. Simple Counters - 524
**** TODO 24.2.2. GCounters - 526
**** TODO 24.2.3. Exercise: GCounter Implementation - 528

*** TODO 24.3. Generalisation - 528
**** TODO 24.3.1. Implementation - 530
**** TODO 24.3.2. Exercise: ~BoundedSemiLattice~ Instances - 531
**** TODO 24.3.3. Exercise: Generic GCounter - 531

*** TODO 24.4 Abstracting GCounter to a Type Class - 532
*** TODO 24.5 Abstracting a Key Value Store - 534
*** TODO 24.6 Summary - 535

* TODO Solutions - 537 - _OUTDATED NEED_UPDATE_
...
* TODO Acknowledgements - 627
*** Acknowledgements from Scala with Cats - 628
**** Backers - 628

* TODO Bibliography - 631
