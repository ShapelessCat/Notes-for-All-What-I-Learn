...
* Acknowledgments - xxi
* TODO 1 Opaque Types - 24
** 1.2 The performance cost of boxing - 24
** 1.2 Use cases for zero-overhead types - 26
** 1.3 The ~AnyVal~ approach - 27
** 1.4 The opaque type approach - 29
** 1.5 Extension methods on opaque types - 32
** 1.6 Bounds on opaque types - 33
** 1.7 Peaking behind the curtain - 35
** 1.8 The ~Matchable~ trait - 37
** 1.9 Conclusion - 41

* TODO 2 Inlining - 42
*** Singleton types - 42
*** Literal singleton types - 46
*** Inlined constants - 47
*** Inlined methods - 49
*** Preserving semantics - 52
*** Partial evaluation - 53
*** Inline methods and inheritance - 56
*** Abstract methods can be inline - 58
*** Performance considerations - 59

** 2.1 Conclusion - 62

* DONE 3 Implementing Lists - 63
...
** DONE 3.1 The ~List~ class in principle - 43
...
** DONE 3.2 The ~ListBuffer~ class - 69
...
** DONE 3.3 The ~List~ class in practice - 70
   CLOSED: [2018-03-20 Tue 03:47]
...
** DONE 3.4 Functional on the outside - 73
...
* DONE 4 For Expressions Revisited - 75
...
** DONE 4.2 The n-queens problem - 78
   CLOSED: [2018-03-28 Wed 23:43]
...
** DONE 4.3 Querying with ~for~ expressions - 81
   CLOSED: [2017-10-21 Sat 22:00]

** DONE 4.4 Translation of ~for~ expressions - 83 =Re-READ=
   CLOSED: [2017-10-21 Sat 22:25]
*** DONE Translating ~for~ expressions with one generator - 83
    CLOSED: [2017-10-21 Sat 22:10]
    ~for (x <- expr1) yield expr2~  ------->  ~expr1.map(x => expr2)~

*** DONE Translating ~for~ expressions starting with a generator and a filter - 83
    CLOSED: [2017-10-21 Sat 22:10]
...
*** DONE Translating ~for~ expressions starting with two generators - 84
    CLOSED: [2017-10-21 Sat 22:10]
...
*** DONE Translating patterns in generators - 85
...
*** DONE Translating definitions - 86
...
** DONE 4.5 Going the other way - 87
...
** DONE 4.6 Generalizing ~for~ - 88 =Re-Read the last some paragraph=
...
** DONE 4.7 Conclusion - 90
   CLOSED: [2017-10-21 Sat 22:29]

* TODO 5 The Architecture of Scala Collections - 91
...
** 5.1 Factoring out common operations - 91
...
*** Abstracting over collection types - 93
*** Handling strictness - 96
*** When strict evaluation is preferable or unavoidable - 99

** 5.2 Integrating new collections - 100
*** Capped sequences - 100
**** Capped collection, first version - 100
**** Capped collection, second version - 103
**** Capped collection, final version - 105

*** RNA sequences - 105
**** RNA strands class, first version - 108
**** RNA strands class, second version - 111
**** RNA strands class, final version - 113
...
** DONE 6.1 An example: extracting email addresses - 124
...
** DONE 6.3 Patterns with zero or one variables - 128
...
** DONE 6.4 Optionless extractors - 130
** DONE 6.5 Variable argument extractors - 133
...
** DONE 6.6 Optionlees variable argument extractors - 137
** DONE 6.7 Extractors and sequence patterns - 139
...
** DONE 6.8 Extractors versus case classes - 141
...
** DONE 6.9 Regular expressions - 143
   CLOSED: [2020-09-27 Sun 04:29]
...
** DONE 6.10 Conclusion - 146 - =RE-READ=
...
** DONE 7.1 Why have annotations? - 147
...
** DONE 7.2 Syntax of annotations - 148
   CLOSED: [2017-10-21 Sat 18:59]
...
** DONE 7.3 Standard annotations - 150
   CLOSED: [2017-10-21 Sat 18:45]
*** DONE Deprecation - 150
...
*** TODO Binary serialization - 152
*** DONE Automatic ~get~ and ~set~ methods - 153 =RE-READ=
    CLOSED: [2017-10-21 Sat 18:45]
...
*** TODO Native methods - 153
    ~@native~

    TODO =???=

** TODO 7.4 Conclusion - 154
   =TODO=
...
* DONE 8 Modular Programming Using Objects - 155 - =Re-READ=
...
** DONE 8.1 The problem - 156 =Re-Read= =Review=
...
** TODO 8.2 A recipe application - 157
** TODO 8.3 Abstraction - 160
   - Use /abstract classes/

** TODO 8.4 Splitting modules into traits - 163
   - Split /every large abstract class/ to multiple /traits/.

** TODO 8.5 Runtime linking - 165
** TODO 8.6 Tracking module instances - 166
** TODO 8.7 Conclusion - 168

* DONE 9 Object Equality - 170
...
** DONE 9.1 Equality in Scala - 170
...
** DONE 9.2 Writing an equality method - 171
...
*** DONE Pitfall #1: Defining ~equals~ with the wrong signature - 172
...
*** DONE Pitfall #2: Changing ~equals~ without also changing ~hashCode~ - 174
...
*** DONE Pitfall #3: Defining ~equals~ in terms of mutable fields - 175
...
*** DONE Pitfall #4: Failing to define ~equals~ as an equivalence relation - 177
    CLOSED: [2018-07-19 Thu 01:19]
...
** DONE 9.3 Defining equality for parameterized types - 183
...
** DONE 9.4 Recipes for ~equals~ and ~hashCode~ - 187
   CLOSED: [2018-07-19 Thu 18:27]
...
* TODO --- Need update the page number of the following chapter sections
* DONE 10 Combining Scala and Java - 194
...
** DONE 10.1 Using Scala from Java - 174
...
** DONE 10.4 Compiling Scala and Java together - 184
...
** DONE 10.5 Java 8 integration - 185
...
** DONE 10.6 Conclusion - 188
   CLOSED: [2018-02-07 Wed 02:10]

* DONE 11 Futures and Concurrency - 209
...
** DONE 11.1 Trouble in paradise - 189 =Re-Do=
...
** DONE 11.2 Asynchronous execution and ~Try~'s - 191
...
** DONE 11.3 Working with ~Future~'s - 194
...
** DONE 11.4 Testing with ~Future~'s - 208
...
* DONE 12 Combinator Parsing - 232
...
** DONE 12.1 Example: Arithmetic expressions - 213
...
** DONE 12.2 Running your parser - 215
...
** DONE 12.3 Basic regular expression parsers - 216
...
** DONE 12.4 Another example: JSON - 217
   CLOSED: [2018-03-05 Mon 19:35]
   ~JSON~ parser

** DONE 12.5 Parser output - 219
...
** DONE 12.6 Implementing combinator parsers - 225
...
** DONE 12.7 String literals and regular expressions - 234
...
** DONE 12.8 Lexing and parsing - 235
...
** DONE 12.10 Backtracking versus LL(1) - 237
...
** DONE 12.11 Conclusion - 239 =Re-Read=
