...
* 1 Functional Programming Strategies - 9
...
*** 2.3.5 Folds as Structural Recursions - 38

** 2.4 Structural Corecursion - 42
*** 2.4.1 Unfolds as Structural Corecursion - 45 - =FIXME= Corecursions ???

** 2.5 Finite State Machines as Algebraic Data Types - 51
** 2.6 The Algebra of Algebraic Data Types - 54
** 2.7 Conclusions - 57

* TODO 3 Objects as Codata - 59
* TODO 4 Contextual Abstraction - 79
...
** DONE 4.1 Anatomy of a Type Class - 42
...
** DONE 4.2 Working with Implicits - 13
...
** DONE 4.3 Exercise: Printable Library - 51
...
** DONE 4.6 Controlling Instance Selection - 61
...
* TODO 5 Reified Interpreters - 105
** 3.1 Regular Expressions - 62
** 3.2 Interpreters and Reification - 71
*** 3.2.1 The Structure of Interpreters - 72
*** 3.2.2 Implementing Interpreters with Reification - 73

** 3.3 Tail Recursive Interpreters - 74
*** 3.3.1 The Problem of Stack Safety - 75
*** 3.3.2 Tail Calls and Tail Position - 75
*** 3.3.3 Continuation‐Passing Style - 78
*** 3.3.4 Trampolining - 83
*** 3.3.5 When Tail Recursion is Easy - 87

** 3.4 Conclusions - 90

* DONE II Type Classes - 137
* DONE 6 Monoids and Semigroups - 67
...
* DONE 7 Functors - 79 - =TODO= _contravariant and invariant functors_
...
* III. Interpreters - 291
* TODO 12 Optimizing Interpreters and Compilers - 293
** 12.1 Algebraic Manipulation - 293
** 12.2 From Continuations to Stacks - 303
** 12.3 Compilers and Virtual Machines - 308
*** 12.3.1 Virtual and Abstract Machines - 308
*** 12.3.2 Compilation - 309

** 12.4 From Interpreter to Stack Machine - 310
*** 12.4.1 Effectful Interpreters - 315
*** 12.4.2 Further Optimization - 316

** 12.5 Conclusions - 319

* IV. Case Studies - 323
* DONE 13 Case Study: Testing Asynchronous Code - 215
...
* DONE 14 Case Study: Map-Reduce - 221
  CLOSED: [2020-02-24 Mon 09:56]
...
* TODO 15 Case Study: Data Validation - 231
  - Goals:
    Be able to
...
** A.1 Tree - 375
** A.2 Methods for Tree - 376
** A.3 Tree Fold - 378
** A.4 Using Fold - 380
** A.5 Iterate - 380
** A.6 Map - 381
** A.7 Identities - 381
** A.8 Identities Part 2 - 382

* TODO B Solutions for: Contextual Abstraction - 383
** B.1 Printable Library - 383
** B.2 Printable Library Part 2 - 384
** B.3 Printable Library Part 3 - 385
** B.4 Cat ~Show~ - 386
** B.5 Equality, Liberty, and Felinity - 387

* TODO C Solutions for: Reified Interpreteres - 389
** TODO C.1 Arithmetic - 389
** TODO C.2 Arithmetic Part 2 - 389
** TODO C.3 Arithmetic Part 3 - 390
** TODO C.4 CPS Arithmetic - 391
** TODO C.5 Exercise: Trampolined Arithmetic - 393

* TODO D Solutions for: ~Monoid~'s and ~Semigroup~'s - 395
** D.1 The Truth About Monoids - 395
** D.2 All Set for Monoids - 396
** D.3 Adding All The Things - 397
** D.4 Adding All The Things Part 2 - 398
** D.5 Adding All The Things Part 3 - 399

* TODO E Solutions for: ~Functor~'s - 401
** E.1 Branching out with Functors - 401
** E.2 Showing off with Contramap - 402
** E.3 Showing off with Contramap Part 2 - 403
** E.4 Transformative Thinking with imap - 404
** E.5 Transformative Thinking with imap Part 2 - 404
** E.6 Transformative Thinking with imap Part 3 - 404

* TODO F Solutions for: ~Monad~'s - 407
** F.1 Getting Func-y - 407
** F.2 Monadic Secret Identities - 408
** F.3 What is Best? - 409
** F.4 Abstracting - 410
** F.5 Safer Folding using Eval - 410
** F.6 Show Your Working - 411
** F.7 Hacking on Readers - 413
** F.8 Hacking on Readers Part 2 - 414
** F.9 Hacking on Readers Part 3 - 414
** F.10 Post-Order Calculator - 415
** F.11 Post-Order Calculator Part 2 - 416
** F.12 Post-Order Calculator Part 3 - 416
** F.13 Branching out Further with Monads - 416

* TODO G Solutions for: Monad Transformers - 421
** G.1 ~Monad~'s: Transform and Roll Out - 421
** G.2 ~Monad~'s: Transform and Roll Out Part 2 - 421
** G.3 ~Monad~'s: Transform and Roll Out Part 3 - 422
** G.4 ~Monad~'s: Transform and Roll Out Part 4 - 422

* TODO H Solutions for: ~Semigroupal~ and ~Applicative~ - 425
** H.1 The Product of Lists - 425
** H.2 Parallel List - 426

* TODO I Solutions for: ~Foldable~ and ~Traverse~ - 427
** I.1 Reflecting on Folds - 427
** I.2 Scaf-fold-ing Other Methods - 428
** I.3 Traversing with Vectors - 429
** I.4 Traversing with Vectors Part 2 - 430
** I.5 Traversing with Options - 430
** I.6 Traversing with Validated - 431

* TODO J Solutions for: Case Study: Testing Asynchronous Code - 433
** J.1 Abstracting over Type Constructors - 433
** J.2 Abstracting over Type Constructors Part 2 - 434
** J.3 Abstracting over Monads - 434
** J.4 Abstracting over Monads Part 2 - 435

* TODO K Solutions for: Case Study: Map-Reduce - 437
** K.1 Implementing ~foldMap~ - 437
** K.2 Implementing ~foldMap~ Part 2 - 437
** K.3 Implementing ~parallelFoldMap~ - 438
** K.4 ~parallelFoldMap~ with more Cats - 440

* TODO L Solutions for: Case Study: Data Validation - 443
** L.1 Basic Combinators - 443
** L.2 Basic Combinators Part 2 - 444
** L.3 Basic Combinators Part 3 - 444
** L.4 Basic Combinators Part 4 - 448
** L.5 Basic Combinators Part 5 - 449
** L.6 Checks - 450
** L.7 Checks Part 2 - 451
** L.8 Checks Part 3 - 452
** L.9 Recap - 453
** L.10 Recap Part 2 - 456
** L.11 Kleislis - 458
** L.12 Kleislis Part 2 - 459

* TODO M Solutions for: Case Study: CRDTs - 339
** M.1 ~GCounter~ Implementation - 463
** M.2 ~BoundedSemiLattice~ Instances - 464
** M.3 Generic ~GCounter~ - 465
** M.4 Abstracting ~GCounter~ to a Type Class - 465
** M.5 Abstracting a Key Value Store - 466
