...
** TODO The Backoff Supervisor Pattern (29:46) - =REDO=
- Problem
...
- Recap:
  ...
  * Timers: schedule messages to sself, from within
    #+begin_src scala
...
**  Delegating Tasks with Routers (30:06)
**  Custom Thread Management with Dispatchers (21:23)
**  Custom Message Processing with Mailboxes (20:53)
